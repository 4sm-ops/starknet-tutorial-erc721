...
from starkware.cairo.common.uint256 import (Uint256, uint256_eq, uint256_check, uint256_lt)
...
# Getting an animal id. tokenOfOwnerByIndex should return the list of NFTs owned by and address
# @view
...
#     let (is_equal) = uint256_eq(n_anim, zero_as_uint256)

#     with_attr error_message("No tokens were minted"):
#         # Verifying that at least 0 token is minted
#         assert is_equal = 0
#     end
